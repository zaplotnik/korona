...
if not ensamble:
    ...
    hr = stats.lognorm.rvs(0.57615709, 2.17310146, 4.19689622)/100.     # hospitalization ratio
    dr = stats.lognorm.rvs(0.44779353, 0.15813357)/100.                 # death ratio, need of intensive care dr/(dr+cr)=0.53
    cr = 0.88679*dr                                                     # critical ratio, need of intensive care
    sr = hr-dr-cr                                                       # severe ratio

    dr_cr = dr/(dr+cr)                    # dr/cr = death rate of critically ill on intensive care
    ...
    end_of_inf =  np.random.normal(2.5,0.5) # after illness onset
