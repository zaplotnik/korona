...
#%% READ SIMULATED DATA
days = np.loadtxt("./overblown/tab_days_096.txt")
Nt =days.shape[0]
...
for i in range(N):
    print(i)
    if os.path.exists("./overblown/tab_active_{:03d}.txt".format(i)):
        
        active[j,:] = np.loadtxt("./overblown/tab_active_{:03d}.txt".format(i))
        infectious[j,:] = np.loadtxt("./overblown/tab_infectious_{:03d}.txt".format(i))
        incubation[j,:] = np.loadtxt("./overblown/tab_incubation_{:03d}.txt".format(i))
        symptoms[j,:] = np.loadtxt("./overblown/tab_symptoms_{:03d}.txt".format(i))
        hospitalized[j,:] = np.loadtxt("./overblown/tab_hospitalized_{:03d}.txt".format(i))
        icu[j,:] = np.loadtxt("./overblown/tab_icu_{:03d}.txt".format(i))
        dead[j,:] = np.loadtxt("./overblown/tab_dead_{:03d}.txt".format(i))
        immune[j,:] = np.loadtxt("./overblown/tab_immune_{:03d}.txt".format(i))
        susceptible[j,:] = np.loadtxt("./overblown/tab_susceptible_{:03d}.txt".format(i))
...
dead_75_normal = np.loadtxt("./data/2020_03_29/dead_75.txt")
dead_25_normal = np.loadtxt("./data/2020_03_29/dead_25.txt")
dead_median_normal = np.loadtxt("./data/2020_03_29/dead_median.txt")
...
plt.plot(days,symptoms_median,label="Symptoms",color="green",lw=3)
...
plt.fill_between(days,dead_25_normal,dead_75_normal,color="black",alpha=0.4)
plt.plot(days,dead_median_normal,label="Fatal",color="black",lw=3)

plt.fill_between(days,dead_25,dead_75,color="blue",alpha=0.4)
plt.plot(days,dead_median,label="Fatal (overcapacity)",color="blue",lw=3)
...
plt.ylim([1,10**5])
plt.legend()
fig.savefig("potek_pandemije{:02d}_overblown.png".format(run),dpi=250)
